...
# ══════════════════════════════════════════════════════════════════════
# Sub-config dataclasses (focused groupings for documentation and
...
class PipelineConfig:
    ...
    * **Preprocessing (deskew)** – minimum rotation angle.
    ...
    # These return a focused sub-config built from the flat fields, giving
    # call sites a path to migrate from cfg.tocr_x_tolerance to
    # cfg.tocr.tocr_x_tolerance without breaking existing code.
    ...
    @classmethod
    def from_yaml(cls, path: str | "Path") -> "PipelineConfig":  # type: ignore[name-defined]
    ...
    @classmethod
    def from_toml(cls, path: str | "Path") -> "PipelineConfig":  # type: ignore[name-defined]
    ...
    @classmethod
    def from_file(cls, path: str | "Path") -> "PipelineConfig":  # type: ignore[name-defined]
...
#: Alias kept so that existing ``from plancheck.config import GroupingConfig``
